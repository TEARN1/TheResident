...
const DERIVED = `
  ...
  /* A scrim laid over a PHOTOGRAPH, so that text on top of it stays readable
     against an arbitrary image. It is dark in both themes on purpose: it is
     darkening someone's photo, not matching one of our surfaces. */
  --scrim: rgb(0 0 0 / 0.55);
  --scrim-strong: rgb(0 0 0 / 0.75);
