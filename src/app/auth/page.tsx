      ...
      >
        ...
        {activeTab === 'login' ? (
          <form onSubmit={handleLogin} style={formStyle}>
            ...
            {/* Google removed for now. To re-add: restore the GoogleMark SVG
                component (see git history) and its button here, once the
                Google OAuth app is set up in Supabase — signInWithProvider
                already supports 'google', nothing else needs to change. */}
            <button
              type="button"
