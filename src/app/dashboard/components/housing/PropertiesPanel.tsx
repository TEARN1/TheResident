    ...
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="bg-accent hover:bg-accent text-content-on-accent font-black px-6 py-3 rounded-2xl flex items-center gap-2 transition-all active:scale-95 shadow-xl shadow-gold-primary/10 uppercase tracking-widest text-xs"
        >
      ...
      {properties.length === 0 ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {properties.map(p => {
            ...
            return (
              <motion.div key={p.id} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="glass-panel p-6 bg-surface-sunken/40 space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="w-full h-2 bg-surface-raised/5 rounded-full overflow-hidden border border-subtle">
          ...
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
            ...
            <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }} className="glass-panel w-full max-w-2xl bg-surface border-accent/20 shadow-2xl relative z-10 overflow-hidden">
              <div className="bg-accent/5 p-6 border-b border-subtle flex justify-between items-center">
                <h3 className="text-xl font-black text-content italic uppercase tracking-tighter">New <span className="text-accent">Property</span></h3>
                <button onClick={() => setShowCreate(false)} className="p-2 text-content-muted hover:text-content transition-colors"><X /></button>
              </div>
              <form onSubmit={handleCreateProperty} className="p-6 space-y-6 max-h-[70vh] overflow-y-auto custom-scrollbar">
                ...
                <div className="pt-4 border-t border-subtle flex gap-4">
                  <button type="button" onClick={() => setShowCreate(false)} className="flex-1 bg-surface-raised/5 text-content font-black py-4 rounded-2xl uppercase tracking-widest text-xs">Cancel</button>
                  <button type="submit" disabled={creating} className="flex-1 bg-accent text-content-on-accent font-black py-4 rounded-2xl uppercase tracking-widest text-xs shadow-xl shadow-gold-primary/20 disabled:opacity-50">
          ...
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
            ...
            <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }} className="glass-panel w-full max-w-xl bg-surface border-accent/20 shadow-2xl relative z-10 p-8 space-y-6">
              ...
              <button
                ...
                className="w-full bg-accent hover:bg-accent text-content-on-accent font-black py-4 rounded-2xl uppercase tracking-widest text-xs shadow-xl disabled:opacity-50"
              >
