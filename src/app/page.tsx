  ...
  return (
    <main className={styles.main}>
      ...
      <footer style={{ display: 'flex', justifyContent: 'center', gap: '20px', padding: '32px 16px', fontSize: '0.75rem', color: 'var(--text-muted)' }}>
        <Link href="/privacy" className="inline-flex items-center min-h-tap px-2" style={{ color: 'inherit', textDecoration: 'none' }}>Privacy Policy</Link>
        <Link href="/terms" className="inline-flex items-center min-h-tap px-2" style={{ color: 'inherit', textDecoration: 'none' }}>Terms of Service</Link>
      </footer>
