  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6" style={{ background: 'var(--background)' }}>
      <Card padding="lg" className="max-w-sm w-full text-center space-y-4">
        <MapPinOff size={36} className="mx-auto text-accent opacity-70" />
        <h1 className="text-lg font-bold text-content">Page not found</h1>
        <p className="text-sm text-content-muted">
          Nothing lives at this address — it may have moved, or the link was mistyped.
        </p>
        <Link
          href="/dashboard"
          className="min-h-[44px] inline-flex items-center justify-center inline-block w-full bg-accent hover:opacity-90 text-content-on-accent font-bold px-4 py-2.5 rounded-xl transition-all text-sm"
        >
          Back to dashboard
        </Link>
      </Card>
