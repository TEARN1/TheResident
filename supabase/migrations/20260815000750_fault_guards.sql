-- ═══════════════════════════════════════════════════════════════════════════
-- 20260815000750_fault_guards
--
-- Adds the two guards the fault lifecycle needs to res_transition_guard.
--
-- The function is re-declared in full rather than patched, because migrations
-- are forward-only and 20260815000400 is applied history. The cost is
-- repetition; the benefit is that this file alone tells you the complete set
-- of guards in force after it runs, which is what you want at 3am.
--
-- Unknown guard names still raise. Failing closed is the entire point: a guard
-- that silently returned true when misspelled would hand automation authority
-- nobody granted it.
-- ═══════════════════════════════════════════════════════════════════════════
